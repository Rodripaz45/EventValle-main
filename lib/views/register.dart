...
class _LogInViewState extends State<LogInView> {
  ...
  void initState() {
    ...
    passwordRepeatFocusNode.addListener(() {
      setState(() {
        passwordRepeatFocus = passwordRepeatFocusNode.hasFocus;
      });
    });
  }
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10.0),
                  border: Border.all(
                    color: passwordRepeatFocus ? Colors.pink : Colors.grey.shade800,
                  ),
                ),
                child: Row(
                  children: [
                  ...
                  onPressed: () {
                    ...
                    if (email.isNotEmpty && email.endsWith("univalle.edu")) {
                      if (passwordController.text ==
                        ...
                        context
                            .read<AuthBloc>()
                            .add(AuthSignInWithEmailPassword(
                              email: email,
